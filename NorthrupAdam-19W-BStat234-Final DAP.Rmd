...
The model that best converges and possibly with the lowest DIC will be the one selected. Initial runs will have 1100 iterations with 100 burnin and thinning of 1. These tuning parameters will be increased if there is high autocorrelation or poor convergence.  
