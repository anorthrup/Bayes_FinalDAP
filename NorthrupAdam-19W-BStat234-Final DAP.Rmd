...
par(mfrow = c(3, 2))
plotACF(burnMod1, n = 1000, paste0("alpha[", 1:6, "]"), "Model 2")
plotACF(burnMod1, n = 1000, paste0("alpha[", 7:12, "]"), "Model 2")
par(mfrow = c(3, 2))
plotTime(burnMod1, n = 1000, paste0("alpha[", 1:6, "]"), "Model 1")
plotTime(burnMod1, n = 1000, paste0("alpha[", 7:12, "]"), "Model 1")
runMod1$BUGSoutput$DIC
runMod2$BUGSoutput$DIC
```
...
priorDataMod3 = list(N.obs = nrow(acasi3), 
                     ...
                     x = x)
proc.time()
runMod3 = jags(priorDataMod3, initsMod3, parametersMod1, 
...
plotTime(burnMod3, n = 1000, "sigma", "Model 3")
runMod3$BUGSoutput$DIC
```
